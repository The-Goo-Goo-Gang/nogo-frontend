  ...
  <div class="game-settings game-view">
    ...
    <div class="game-view-form">
      ...
      <div class="game-view-form-item">
        <div class="game-view-form-item-title">背景音乐</div>
      ...
      <div class="game-view-form-item" v-if="playBgm">
        <div class="game-view-form-item-title">背景音乐音量</div>
      ...
      <div class="game-view-form-item" v-if="playBgm">
        <div class="game-view-form-item-title">背景音乐来源</div>
        <div class="game-view-form-item-content">
          <div class="game-view-form-item-content-item">
            <label class="game-view-form-item-content-item-label">
      ...
      <div class="game-view-form-item" v-if="playBgm && bgmType === BackgroundMusicType.LOCAL">
        <div class="game-view-form-item-title">本地音乐文件</div>
        <div class="game-view-form-item-content full-width">
          <FileSelector class="game-view-form-item-content-item" v-model:file="file" accept="audio/*" :multiple="true" />
        </div>
      </div>
      <div class="game-view-form-item" v-else-if="playBgm && bgmType === BackgroundMusicType.NETEASE">
        <div class="game-view-form-item-title">网易云音乐 ID（多首歌曲用,分割）</div>
        <div class="game-view-form-item-content full-width">
          <div class="game-view-form-item-content-item">
            <label class="game-view-form-item-content-item-label">
